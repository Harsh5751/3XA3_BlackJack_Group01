$(document).ready(function() {
  ...
  startButton.addEventListener('click', function() {
    ...
    gameLogic = new gamePlayLogicPontoon(gamePlayer, gameDealer, gameDeck);
  ...
  dealButton.addEventListener('click', function() {
    ...
    gameDealer.dealerUpdatePontoon();
    gameDealer.dealerCards.push(gameDeck.dealCard());
    gameDealer.dealerUpdatePontoon();
  ...
  //Adds 10 to current wager and subtracts 100 from currentChipBalance, updates visuals appropriately
  ...
  //Player indicates they want to stop being dealt cards. Only allowed to do so if score > 15 or they have 5 or more cards
  stayButton.addEventListener('click', function() {
    if (gamePlayer.playerScore < 15 && gamePlayer.playerCards.length < 5){
      swal({
        title: "You must have either a score of at least 15 or have at least 5 cards in your hand to stay",
        text: "You can continue to play by selecting the hit button",
        icon: "warning",
        button: "Close!",
      });
      return;
      ...
      if (gameLogic.playerWon === true && (gamePlayer.playerCards.length == 2 || gamePlayer.playerCards.length == 5) && gamePlayer.playerScore == 21) {
        gamePlayer.currentChipBalance += (gamePlayer.currentWager *2);
        currentBalance.innerText = 'Chip Balance: ' + gamePlayer.currentChipBalance;
  ...
  yesButton.addEventListener('click', function() {
    ...
    chip50.style.display = 'inline';
    chip100.style.display = 'inline';
    if(gamePlayer.currentChipBalance < 10 && hasMoney === true){ //Player will only be prompted once
      swal({
  ...
  //Player indicates that they do not want to continue playing, brought back to main pontoon screen
