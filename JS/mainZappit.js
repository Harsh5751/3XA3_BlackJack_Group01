...
var startButton = document.getElementById('startButton'),
  ...
  zapButton = document.getElementById('zapButton'),
...
startButton.addEventListener('click', function() {
  ...
  gameLogic = new gamePlayLogicZappit(gamePlayer, gameDealer, gameDeck);
...
dealButton.addEventListener('click', function() {
  ...
  // if the player has a score between 15 and 18 the zappit button will appear and they can choose two new cards
  if (gamePlayer.score >= 15 && gamePlayer.score <= 18 && gamePlayer.playerCards.length == 2 && !hasZapped) {
...
stayButton.addEventListener('click', function() {
  ...
  gameLogic.checkForWinner();
  if (gameLogic.playerWon === true && gamePlayer.playerCards.length == 2 && gamePlayer.playerScore == 21 && hasZapped === false) {
...
//Player indicates they want to change their inital hand and receive two new cards
zapButton.addEventListener('click', function() {
  hasZapped = true;
  gameLogic.zapped = true;
  gameLogic.zappitReset();
  gamePlayer.playerCards.push(gameDeck.dealCard());
  gamePlayer.playerUpdate();
  gamePlayer.playerCards.push(gameDeck.dealCard());
  gamePlayer.playerUpdate();
...
//Player indicates that they do not want to continue playing, brought back to main zappit screen
